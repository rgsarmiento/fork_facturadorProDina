    ...
    <div v-loading="loading">
        <div class="page-header pr-0">
            ...
            <div class="right-wrapper pull-right">
                ...
                <el-button class="submit mt-2 mr-2" type="primary"  :loading="loading" @click.prevent="clickRunProcess()"><i class="fa fa-check"></i> Procesar correos</el-button>
            </div>
        </div>
        <div class="card mb-0">
...
<script>
    ...
    export default {
        components: {DataTable, DetailForm},
        data() {
            return {
