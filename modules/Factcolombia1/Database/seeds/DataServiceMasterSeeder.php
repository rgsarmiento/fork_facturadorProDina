...
class DataServiceMasterSeeder extends Seeder
{
    /**
     * Prefix.
     *
    ...
    public $tables = [
        ...
        'service_type_document_identifications' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],
        'service_taxes' => [
            'columns' => 'id, name, description, code, @created_at, @updated_at',
        ],
        'service_type_regimes' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],
        'service_type_liabilities' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],      
        'service_type_currencies' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],
        'service_type_operations' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],
        'service_type_environments' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
        ],
        'service_languages' => [
            'columns' => 'id, name, code, @created_at, @updated_at',
