<template>
    <div class="card mb-0 pt-2 pt-md-0">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-6 pb-2">
                                <div class="form-group" :class="{'has-danger': errors.worker_id}">
                                    ...
                                    <el-select v-model="form.worker_id" filterable remote class="border-left rounded-left border-info" popper-class="el-select-customers"
                                        placeholder="Escriba el nombre o número de documento del empleado"
                                        :remote-method="searchRemoteWorkers"
                                        :loading="loading_search"
                                        @change="changeWorker">

                                        <el-option v-for="option in workers" :key="option.id" :value="option.id" :label="option.search_full_name"></el-option>
        ...
        <!-- <document-form-item ref="documentFormItem" :showDialog.sync="showDialogAddItem"
